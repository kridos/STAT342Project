...
Both the numeric and bootstrapped confidence intervals do not contain values that are less than or equal to 0.3. With this reasoning, we have sufficient evidence to reject our null hypothesis. Therefore, using the frequentist approach, we can say that we have a sufficient amount of evidence support the notion that the vaccine efficacy is greater than 0.3.
