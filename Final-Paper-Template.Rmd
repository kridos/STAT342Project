...
```
We choose these apriori beliefs to analyze the data and sensitivity of the prior. In other words, these priors represent varying degrees of pessimism and optimism regarding whether the vaccine exceeds the FDA efficacy threshold of 30% and whether it provides any beneficial effect.
